...
@Mod(AstrologicalResonance.MOD_ID)
public class AstrologicalResonance {
    public static final String MOD_ID = "astrologicalresonance";

    public AstrologicalResonance(IEventBus modEventBus, ModContainer modContainer) {
